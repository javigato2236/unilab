...
# df = pd.read_excel("inventario.xlsx",sheet_name="INV_REACTIVOS_ZINC")

# with pd.ExcelWriter('extraccionCobalo.xlsx', engine='openpyxl') as writer:
...
# df = pd.read_excel("inventario.xlsx",sheet_name="INV_REACTIVOS_OTROS")

# with pd.ExcelWriter('extraccionCobre.xlsx', engine='openpyxl') as writer:
#     # 'startrow' y 'startcol' indican dónde comenzar (índice basado en 0)
#     df.to_excel(writer, sheet_name='HojaNueva', startrow=10, startcol=1, index=False)


# df = pd.read_excel("inventario.xlsx",sheet_name="INV_REACTIVOS_LITIO")

# with pd.ExcelWriter('extraccionColorantes.xlsx', engine='openpyxl') as writer:
#     # 'startrow' y 'startcol' indican dónde comenzar (índice basado en 0)
#     df.to_excel(writer, sheet_name='HojaNueva', startrow=10, startcol=1, index=False)


# df = pd.read_excel("inventario.xlsx",sheet_name="INV_REACTIVOS_YODO (I)")

# with pd.ExcelWriter('extraccionAmonio.xlsx', engine='openpyxl') as writer:
#     # 'startrow' y 'startcol' indican dónde comenzar (índice basado en 0)
#     df.to_excel(writer, sheet_name='HojaNueva', startrow=10, startcol=1, index=False)
